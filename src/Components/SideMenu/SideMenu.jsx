...
export default function SideMenu() {
    ...
    const [openEmployeeCertifications, setOpenEmployeeCertifications] = React.useState(true);
                ...
                {accountRoles.includes("TPD Team") ? (
                    <List>
                        ...
                        <ListItem button onClick={handleSkillsClick} key={"Skills"}>
                            ...
                            <ListItemText primary={"Skills"} className={clsx(classes.navBarList)} />
                            {openSkills ? (
                                <ArrowDropUpIcon className={clsx(classes.navBarIcons)} />
                            ) : (
                                <ArrowDropDownIcon className={clsx(classes.navBarIcons)} />
                        ...
                        <ListItem button onClick={handleCertificationsClick} key={"Certifications"}>
                            <ListItemIcon className={clsx(classes.navBarIcons)}>
                                {/* <img src={PsychologyIcon}></img> */}
                            </ListItemIcon>
                            <ListItemText
                    ...
                    <List>
                        ...
                        <ListItem button onClick={handleAssignmentsClick} key={"Assignments"}>
                            <ListItemIcon className={clsx(classes.navBarIcons)}>
                                {/* <img src={PsychologyIcon}></img> */}
                                <AssignmentIcon />
                            </ListItemIcon>
                        ...
                        <Collapse in={openEmployeeCertifications} timeout="auto" unmountOnExit>
                            <List component="div" disablePadding>
                                <ListItem
                                    button
                                    className={clsx(classes.navBarSubList)}
