...
import { employeeService, trainingService } from "#Services";
...
export default function EmployeeTrainings() {
    ...
    const handleFilter = () => {
        ...
        var filterActivty = selectedActivty ? { training_activity_name: selectedActivty } : "";
        var filterFromDate = selectedFromDate ? { event_from_date: selectedFromDate } : "";
    ...
    return (
        <div>
            ...
            <Dialog
                ...
                <DialogTitle id="responsive-dialog-title">Employee Trainings Filter</DialogTitle>
                <DialogContent>
                    <Autocomplete
