...
import { releaseRequestService, managerService, employeeService } from "#Services";
...
export default function ReleaseReq() {
    ...
    useEffect(() => {
        ...
        const functionFilterProperty = selectedFunction ? { function: selectedFunction } : "";
        const employeeFilterProperty = selectedEmployee ? { employee_name: selectedEmployee } : "";

        const statusFilterProperty = selectedStatus ? { request_status: selectedStatus } : "";
        const Filters = {
    ...
    const exportRequests = () => {
        ...
        if (accountProperties().roles?.includes("TPD Team")) {
            managerFilterProperty = selectedManager ? { manager_name: selectedManager } : "";
        }
        const titleFilterProperty = selectedTitle ? { employee_title: selectedTitle } : "";
        const functionFilterProperty = selectedFunction ? { function: selectedFunction } : "";
        const employeeFilterProperty = selectedEmployee ? { employee_name: selectedEmployee } : "";
    ...
    return (
        <div>
            ...
            <div className="table-responsive-lg">
                <table className="table resourceTable mx-auto table-striped table-condensed">
                            ...
                            <tr>
                                ...
                                <td className="btn-group">
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            editRequest(releaseRequest.reference_number)
                                        }>
                                        <EditIcon />
                                    </IconButton>
            ...
            <div
                className="modal fade releaseFilter"
