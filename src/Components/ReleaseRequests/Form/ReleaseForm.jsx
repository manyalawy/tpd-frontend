...
export default function ReleaseForm(props) {
    ...
    const [statusSelectedOption, setStatusSelectedOption] = useState(statusOptions[0]);
    ...
    const handleSubmit = (e) => {
        ...
        if (props.location?.state?.editing) {
            ...
            releaseRequestService.update({ ...ReleaseRequest, reference_number }).then((res) => {
                if (res.error) {
        ...
        <div>
            ...
            <div className="form-width mx-auto">
                <form>
                    ...
                    <button class="btn btnBlue btn-primary" onClick={(e) => handleSubmit(e)}>
                        {props.location?.state?.editing
