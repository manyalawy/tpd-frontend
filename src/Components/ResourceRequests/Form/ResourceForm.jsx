...
import { resourceRequestService, managerService, employeeService, skillService } from "#Services";
...
export default function ResourceForm(props) {
    ...
    const [statusSelectedOption, setStatusSelectedOption] = useState(tpdOptions[0]);
    ...
    const [selectedAssignedResource, setSelectedAssignedResource] = React.useState(null);
    ...
    const handleSubmit = () => {
        ...
        if (props.location?.state?.editing) {
            ...
            resourceRequestService.update({ ...ResourceRequest, reference_number }).then((res) => {
                if (res.error) {
        ...
        <div>
            ...
            <div className="form-width mx-auto form">
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <Autocomplete
                                ...
                                disabled={accountProperties().roles?.includes("Manager")}
                                onChange={(event, value) =>
                                    value == null ? setSelectedTitle(null) : setSelectedTitle(value)
                                }
                                {...titleDropDownList}
                                id="selectTitle"
                                clearOnEscape
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <Autocomplete
                                ...
                                disabled={
                                    replacmentCheck == true && selectedManager != "" ? false : true
                                }
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-check">
                                <input
                                    ...
                                    onChange={(event) => setCoreTeam(event.target.checked)}></input>
                                <label class="form-check-label" for="leaving">
                                    Core Team Member
                                </label>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <div class="form-group">
                                ...
                                <textarea
                                    onChange={(event) => setSelectedRelatedOpp(event.target.value)}
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <Autocomplete
                                ...
                                id="selectStatus"
                                renderInput={(params) => (
                                    <TextField {...params} label="Select Status" margin="normal" />
                                )}
                            />
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <button class="btn btn-primary sub" type="submit" onClick={handleSubmit}>
                        {props.location?.state?.editing
...
const managerOptions = [{ status: "Open" }, { status: "Cancelled" }, { status: "On Hold" }];
