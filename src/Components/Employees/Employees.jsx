...
function createData(name, tit, date, func, man, work, emp, allo, skills, actions) {
...
export default function Employees() {
    ...
    const handleFilter = () => {
        ...
        var filterWorkgroup = selectedWorkgroup ? { workgroup: selectedWorkgroup } : "";
        const Filters = {
            ...filterName,
            ...filterTitle,
            ...filterFunction,
